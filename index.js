...
        
        /* Global Background Image using the user's provided image, with a slightly lighter overlay for visual appeal and readability */
        background-color: var(--primary-text);
        /* --- MODIFIED: Changed overlay opacity from 0.9 to 0.7 --- */
        background-image: linear-gradient(rgba(34, 34, 34, 0.7), rgba(34, 34, 34, 0.7)), url('${LANDING_IMAGE_URL}');
